...
```css
--space-xs: 0.5rem /*  8px */ --space-sm: 1rem /* 16px */ --space-md: 2rem
  /* 32px */ --space-lg: 4rem /* 64px */ --space-xl: 8rem /* 128px */;
```
...
```css
--shadow-card:
  0 10px 30px -10px rgba(42, 36, 33, 0.08),
  0 4px 6px -2px rgba(42, 36, 33, 0.04);
...
<a href="/">
  Sue Wheeler
  <!-- Playfair Display, 1.4rem, italic -->
  <span>Wood Refinishing</span>
  <!-- Inter, 0.6rem, uppercase, sue-muted -->
</a>
```
...
<!-- sue-wood border + text -->
<span class="pill-badge blue">Label</span>
<!-- sue-blue border + text -->
```
...
- Content (top to bottom):
  ...
  6. Footer bar: logo name (left) + "EPA Certified · Est. 1989 · St. Louis Magazine" (right)
