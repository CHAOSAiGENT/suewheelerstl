...
const faqItems = [
  {
    question: "My dining room hutch has leaded glass inserts. Can you refinish around the glass?",
    answer:
  ...
  {
    question: "The finish on my hutch is peeling and very dark. Can it really be restored?",
    answer:
  ...
  {
    question: "My built-in bookcase has some shelves that are warped or damaged. Can that be addressed?",
    answer:
    ...
    <>
      ...
      <section className="py-16 px-6" style={{ backgroundColor: "#F8F6F1" }}>
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-4 text-[#6B5E55] font-sans text-base leading-relaxed">
            <p>
              The built-in hutches, buffets, and bookcases in St. Louis&rsquo;s pre-war homes were
              built from old-growth lumber — white oak, American chestnut, heart pine — and
              constructed by craftsmen working to architectural specifications. The profiles, the
              glass door details, the leaded light inserts, the proportions: these were designed
              for the room they&rsquo;re in. They&rsquo;re irreplaceable in any meaningful sense
              of the word.
            </p>
            <p>
              New cabinetry built to approximate the original is a compromise: different wood
              species, different grain density, machine-cut profiles that don&rsquo;t read as
              period-accurate. The original is always better than the reproduction. Refinishing is
              the only approach that preserves it.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-6" style={{ backgroundColor: "#EBE6DE" }}>
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-4 text-[#6B5E55] font-sans text-base leading-relaxed">
            <p>
              Built-in pieces are worked on in place — they&rsquo;re structural to the home or too
              large to safely remove. We use appropriate solvents and hand tools to strip the
              existing finish, assess and address any surface damage, stain to match or update the
              existing tone, and apply polyurethane.
            </p>
            <p>
              For pieces with glass inserts — hutch doors, leaded glass bookcases — we mask
              carefully around the glass. For pieces with multiple components (upper and lower
              cabinet, separate shelving units), we treat the system as a unit so the finish reads
      ...
      <section className="py-16 px-6" style={{ backgroundColor: "#F8F6F1" }}>
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-[#6B5E55] font-sans text-base leading-relaxed">
            Built-in hutches and buffets are most common in dining rooms; built-in bookcases appear
            in libraries, studies, and living rooms. These are the rooms where finish condition is
            most noticed — formal spaces, rooms where guests spend time, rooms that appear in
            listing photos.
          </p>
          <p className="mt-4 text-[#6B5E55] font-sans text-base leading-relaxed">
            A refinished dining room hutch transforms the entire room. The same woodwork that
            looked dark and tired becomes the feature it was designed to be.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 px-6" style={{ backgroundColor: "#EBE6DE" }}>
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-[#6B5E55] font-sans text-base leading-relaxed">
            The people who built these homes invested in quality materials and skilled labor because
            they expected the work to last. Every homeowner who has lived there since has been the
            steward of that investment. Refinishing rather than replacing is the act that honors it.
          </p>
        </div>
      </section>
      ...
      >
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-[#6B5E55] font-sans text-base leading-relaxed">
            The finish on built-in cabinetry in pre-1978 homes almost certainly contains lead. Sue
            Wheeler is an EPA Certified Lead Renovator. Every pre-1978 project includes proper
            containment, HEPA filtration, and documented cleanup. Especially relevant in dining
