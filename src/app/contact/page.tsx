          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div>
              ...
              <p className="text-lg text-[#6B5E55] font-sans mb-10 leading-relaxed">
                Sue answers every call personally. Tell her what you have —
                she&rsquo;ll tell you what it needs.
              </p>
              ...
              <div className="mb-10">
                ...
                >
                  <Phone size={24} className="text-[#11B2E8] shrink-0" />
                  <span className="text-3xl font-sans font-medium text-[#2A2421] group-hover:text-[#11B2E8] transition-colors">
                    (314) 367-6054
                  </span>
                </a>
                <p className="text-sm text-[#6B5E55] font-sans mt-2 ml-9">
                  Sue Wheeler answers personally. No call centers. No
                  schedulers.
                </p>
              </div>
              ...
              <div className="mb-10">
                ...
                <div className="flex items-start gap-3">
                  <MapPin
                    size={18}
                    className="text-[#11B2E8] mt-0.5 shrink-0"
                  />
                  <div className="text-sm font-sans text-[#6B5E55]">
                    ...
                    <p className="mt-2">
                      ...
                      unsure whether we serve your area, call and ask.
                    </p>
                  </div>
                </div>
              </div>
              ...
              {/* Map embed */}
              <div
                className="aspect-video bg-[#F8F6F1] overflow-hidden"
